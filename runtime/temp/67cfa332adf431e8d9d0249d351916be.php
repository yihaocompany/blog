<?php /*a:1:{s:54:"D:\wwwroot\blog\application\admin\view\public_head.php";i:1550392561;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <title><?php echo htmlentities($configs['webname']); ?>后台管理</title>
        ...
        <div class="admin">
            <div class="aleft">
                ...
                <ul class="cl">
                    ...
                    <li><i class="layui-icon">&#xe63c;</i><a href="<?php echo url('Links/index'); ?>">友情链接</a></li>
