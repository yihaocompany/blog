...
<html>
    <head>
        <title><?php echo htmlentities($configs['webname']); ?>后台管理系统</title>
    ...
    <body id="login">
        <div class="login">
            <h2><?php echo htmlentities($configs['webname']); ?>后台管理</h2>
            ...
            <div class="layui-form-item">
                <table>
                    <tr>
                        ...
                        <td><img src="<?php echo url('login/verify'); ?>" title="点击刷新" height="38"  id="verify_img" onclick="refreshVerify()"></td>
                    </tr>
                </table>
            </div>
            <div class="layui-form-item">
        ...
        <script>
            ...
            function refreshVerify() {
                ...
                img.src = "<?php echo url('login/verify'); ?>?id="+ts;
            }
        </script>
    </body>
</html>