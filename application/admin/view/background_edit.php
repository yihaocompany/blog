...
<div class="aright">
    ...
    <form class="layui-form bform" method="post" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    ...
                    <if ($info['side_img'])><img src="{$info.side_img|default=''}" width="120"><else/></if>
        ...
        <div class="layui-form-item" style="width: 300px;">
            ...
            <div class="layui-input-block">
                <select name="status">
                    <volist name="notes.is_side" id="vo">
                        <option <if ($info['is_side']==$key)>selected="selected"</if> value="{$key}">{$vo}</option>
                    </volist>
                </select>
            </div>
        </div>
